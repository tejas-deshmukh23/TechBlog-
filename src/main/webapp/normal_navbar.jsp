      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <a class="nav-link" href="#"><i class="fa-regular fa-address-book"></i>Contact</a>
           ...
           <li class="nav-item">
          <a class="nav-link" href="login_page.jsp"><i class="fa-solid fa-user"></i>Login</a>
        </li>
           <li class="nav-item">
               <a class="nav-link" href="register_page.jsp"><i class="fa-solid fa-user-plus"></i>Sign up</a>
        </li>
